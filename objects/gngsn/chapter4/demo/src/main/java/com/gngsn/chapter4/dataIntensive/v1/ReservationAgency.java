...
//            discountable = condition.getType() == DiscountConditionType.PERIOD ?
//                    isScreenTimeValid(screening, condition) : condition.getSequence() == screening.getSequence();
...
//    private static boolean isScreenTimeValid(Screening screening, DiscountCondition condition) {
